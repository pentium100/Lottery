...
public class SendMail {
	...
	private final boolean needAuth = false; // smtp是否需要认证
	// smtp认证用户名和密码
	...
	static final org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger
			.getLogger(com.itg.bot.SendMail.class);
	 ...
	 *            邮件发送服务器
	 */
	public SendMail(final String smtp) {
	 ...
	 *            String
	 */
	public final void setSmtpHost(final String hostName) {
	 ...
	 * @return
	 */
	public final boolean createMimeMessage() {
	...
	public static boolean sendAndCc(String smtp, String from, String to,
			String copyto, String subject, String content, String username,
			String password, String filename) throws MessagingException {
		SendMail theMail = new SendMail(smtp);
		theMail.setNeedAuth(true); // 需要验证
